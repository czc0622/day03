...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="dname" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">设备状态</span>
					<select class="form-control" name="status" id = "txt_search_roleid">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveDevice.htm">
						<input type="hidden" name="did" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>设备名称：</td>
								<td><input type="text" id="username" name="dname"
							...
							<tr>
								<td>内存：</td>
								<td><input type="text" id="dram" name="dram"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>机身颜色：</td>
							...
							<tr>
								<td>设备类型：</td>
								<td colspan="2">
									<select class="form-control" name="tid" id = "roleid" aria-required="true" required>
										<option value="">---请选择---</option>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            dname: $("#txt_search_username").val(),
	            status: $("#txt_search_roleid").val(),
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
		    	var MyEcharts=echarts.init(document.getElementById("app"));
		    	    ...
		    	    $.ajax({
		    	    	...
		    	    	success:function(res){
		    	    		if(res.success){
		    	    			...
		    	    			res.data.forEach(function(dtype){//饼图数据处理
		    	    				
		    	    				xary.push(dtype.tname);
		    	    			    yary.push( {value: dtype.num, name: dtype.tname});
	...
	function initEditUser(getSelection){
		$('#hidden_txt_userid').val(getSelection.did);
		$('#roleid').val(getSelection.tid);
		$('#username').val(getSelection.dname);
		$('#price').val(getSelection.price);
		$('#color').val(getSelection.color);
		$('#dram').val(getSelection.dram);
